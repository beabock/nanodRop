...
```{r plots, fig.cap="Visualization of spectral data", fig.alt=c("Line plot of absorbance spectra for multiple samples.", "Heatmap of absorbance values for each sample across wavelengths.")}
...
```{r integration, fig.cap="Comparison of original and smoothed spectra", fig.alt="Faceted line plots comparing original and smoothed absorbance spectra for each sample."}
